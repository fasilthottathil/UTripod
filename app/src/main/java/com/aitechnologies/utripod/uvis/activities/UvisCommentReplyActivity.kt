...
import com.aitechnologies.utripod.uvis.viewModels.UvisReplyCommentViewModel
import com.aitechnologies.utripod.uvis.viewModels.UvisReplyCommentViewModelProvider
...
class UvisCommentReplyActivity : AppCompatActivity() {
    ...
    private lateinit var postReplyCommentViewModel: UvisReplyCommentViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val uvisReplyCommentViewModelProvider =
            UvisReplyCommentViewModelProvider(UvisRepository(application))

        postReplyCommentViewModel = ViewModelProvider(
            this,
            uvisReplyCommentViewModelProvider
        )[UvisReplyCommentViewModel::class.java]
    ...
    private fun setupRecyclerView() {
        binding.rvComments.apply {
            ...
            layoutManager = LinearLayoutManager(this@UvisCommentReplyActivity)
