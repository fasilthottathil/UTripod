...
import com.aitechnologies.utripod.databinding.ActivityPostHashTagBinding
...
class PostHashTagActivity : AppCompatActivity() {
    private lateinit var binding: ActivityPostHashTagBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPostHashTagBinding.inflate(layoutInflater)
        ...
        postHashTagViewModel.getPostByHashtags(
            hashtag.replace("#", "")
        )
    ...
    private fun setupRecyclerView() {
        binding.rvPosts.apply {
            ...
            layoutManager = LinearLayoutManager(this@PostHashTagActivity)
            adapter = postAdapter
        }
    }
